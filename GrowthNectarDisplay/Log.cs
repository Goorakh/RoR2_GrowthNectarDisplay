...
namespace GrowthNectarDisplay
{
    internal static class Log
    {
        ...
        static Log()
        {
            ...
            {
                const string MOD_NAME = nameof(GrowthNectarDisplay) + @"\";
                ...
                {
                    UnityEngine.Debug.LogError($"[{GrowthNectarDisplayPlugin.PluginName}] Logger failed to determine caller path prefix length");
                    return 0;
                }
            }
        }
